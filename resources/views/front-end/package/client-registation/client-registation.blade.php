          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                ...
                {!! Form::open(['route'=>'save-package', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'class'=>'user']) !!}
                ...
                <div class="form-group row">
                    <label for="package" class="col-sm-2 col-form-label">Select Your Package</label>
                    <div class="col-sm-10">
                        <select  data-live-search="true"  name="package" id="package" class="form-control">
